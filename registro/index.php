	...
	<div id="inicio" style="box-shadow:6px 7px 7px 0px rgba(50, 50, 50, 0.42);">
		...
		<div id="nombre">
			<form method="POST" action="">
				...
				<input type="password" name="contraseña" required="" size="37%" placeholder="Contraseña" style="margin-bottom:5%;">
				<input type="password" name="contraseña2" required="" size="37%" placeholder="Repite contraseña" style="margin-bottom:5%;">
